...
# setwd("/home/guosa/hpc/rheumatology/RA/meta3000/BEND5")
# snp="rs1934409"
# locusname="rs1934409"
# chr=1
# localhitfile="rs1934409.local"
# range=6
# best.pval=0.01
...
make.fancy.locus.plot <- function(snp, locusname, chr, locus, range, best.pval){
  ...
  # genes in the region
  #
  genelist <- read.table("~/hpc/db/hg19/refGene.hg19.fancylocal.bed", header=F)
  # genelist <- read.table("//mcrfnas2/bigdata/Genetic/Projects/shg047/db/hg19/refGene.hg19.fancylocal.bed", header=F)
